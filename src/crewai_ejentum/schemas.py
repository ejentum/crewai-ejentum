...
class EjentumHarnessParams(BaseModel):
    ...
    mode: HarnessMode = Field(
        ...
        description=(
            ...
            "(spans abstraction, time, causality, simulation, spatial, metacognition). "
            ...
            "(spans sycophancy, hallucination, deception, adversarial framing, "
            "judgment, executive control). "
            "'memory' only when sharpening an observation already formed about "
            "cross-turn drift (perception layer)."
        ),
    )
